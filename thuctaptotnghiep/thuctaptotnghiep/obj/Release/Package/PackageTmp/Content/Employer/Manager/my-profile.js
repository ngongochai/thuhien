...
$(function () {
        ...
        uploadDirectly: function (el) {
            if (el.files && el.files[0]) {
                ...
                if (['jpeg', 'jpg', 'png', 'gif'].indexOf(fileExt.toLowerCase()) > -1) {
                    ...
                    fnPhotoEdit.updatePhoto(el);
                }
            }
        }
    };
    $('#logo_logo_cropper').on('hidden.bs.modal', function () {
    ...
    $('#logo_logo_update').on('click', function (e) {
        $('.btn-upload-logo').simulate('click');
    });

    $('#logo_logo_remove').on('click', function (e) {
        fnPhotoEdit.removePhoto(e.target);
    ...
    $('#save_profile_change').on('click', function (e) {
        formValidator.form();
        if (formValidator.valid()) {
            fnSaveChangesLoading.open($('#loading_template').html())
                .done(function () {
                    // show complete
                    swal({
                        title: window.messages.save_success_title,
                        text: window.messages.save_success_message,
                        type: "success",
                        timer: 1500,
                    ...
                    swal({
                        title: window.messages.something_went_wrong,
                        text: window.messages.general_error,
                        type: "error"
                    });
                });
            $('#profile_form').submit();
    ...
    $('#save_logo_change').on('click', function (e) {
        formLogoValidator.form();
        if (formLogoValidator.valid()) {
            fnSaveChangesLoading.open($('#loading_template').html())
                .done(function () {
                    location.reload();
                    // show complete
    ...
    $('#profile_form,#companyLogo').on('submit', function (e) {
        e.preventDefault();
    ...
    $('.btn-save-email').click(function (event) {
        //event.preventDefault();
...
$('#logo_photos_add').on('click', function (e) {
    $(this).closest('.row').find('>div:lt(3):hidden').first().find('input[type="file"]').simulate('click');
});
$('#logo_photo1_file,#logo_photo2_file,#logo_photo3_file').on('change', function (e) {
...
$('#logo_photo1_update,#logo_photo2_update,#logo_photo3_update').on('click', function (e) {
    $(this).closest('.upload-company-photo-item-container').find('.btn-upload-photo').simulate('click');
});
$('#logo_photo1_remove,#logo_photo2_remove,#logo_photo3_remove').on('click', function (e) {
...
var fnUpdateStateOfAddPhotoButton = function () {
    var isShowAddPhotoButton = $('#logo_photos_add').closest('.row').find('>div:lt(3):hidden').length > 0;
    if (isShowAddPhotoButton) {
        $('#logo_photos_add').closest('.upload-company-photo-item').slideDown(100);
    } else {
        $('#logo_photos_add').closest('.upload-company-photo-item').slideUp(100);
    }
};
