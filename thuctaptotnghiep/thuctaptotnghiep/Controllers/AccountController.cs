    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            if (user == null)
            {
                ...
                Session["Member"] = new Member() {MAUV=user1.MAUV, Ten = uv.Ten, EmailDN = uv.EmailDN, Loaitaikhoan = uv.Loaitaikhoan };
            ...
            else
            {
                ...
                {
                    Session["Member"] = new Member() { MAUV = user.MAUV, Hovatendem = user.Hovatendem, Ten = user.Ten, EmailDN = user.EmailDN, Loaitaikhoan = user.Loaitaikhoan, };
                ...
                {
                    Session["Supper"] = new UngVien() { MAUV = user.MAUV, EmailDN = user.EmailDN, Hovatendem = user.Hovatendem, Ten = user.Ten, Loaitaikhoan = user.Loaitaikhoan, vaitro = user.vaitro };
                    Session["SESSIONFILEPATH"] = "~/Content/Uploaded";
                    if (callback != null && callback != "")
                    {
                        return Redirect(callback);
