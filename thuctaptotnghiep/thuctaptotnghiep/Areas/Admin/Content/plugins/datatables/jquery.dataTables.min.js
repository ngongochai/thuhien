    ...
    var P = function (h) {
        ...
        []; m.models = {}; m.models.oSearch = { bCaseInsensitive: !0, sSearch: "", bRegex: !1, bSmart: !0 }; m.models.oRow = { nTr: null, anCells: null, _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, _sRowStripe: "", src: null }; m.models.oColumn = {
            ...
            fnStateLoaded: null, fnStateSaveCallback: function (a, b) { try { (-1 === a.iStateDuration ? sessionStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b)) } catch (c) { } }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
                oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "Trang đầu", sLast: "Trang cuối", sNext: "Tiếp", sPrevious: "Sau" },
                sEmptyTable: "Không có dữ liệu", sInfo: "Hiển thị từ _START_ to _END_ of _TOTAL_ mẫu tin", sInfoEmpty: "Hiển thị 0 to 0 of 0 mẫu tin", sInfoFiltered: "", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Hiển thị _MENU_ mẫu tin", sLoadingRecords: "Đang tải...", sProcessing: "Đang xử lý...", sSearch: "Tìm kiếm:", sSearchPlaceholder: "Tìm kiếm tất cả...", sUrl: "", sZeroRecords: "Không có dữ liệu"
