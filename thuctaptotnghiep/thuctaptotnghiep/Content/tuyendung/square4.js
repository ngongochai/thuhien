var Square4 = {
    ...
    exec_request : function () {
        var requestURL = 'vclick/index.php?group=common&zone=8';
        var wrapper = jQuery('#ads_ADV_HOME_4');
        Square4.display_animation(wrapper, true);

        jQuery.ajax({
            url: requestURL,
            success: function(result) {
                Square4.display_animation(wrapper, false);
                ...
                Square4.render_ads(wrapper, result.data.result);
                Square4.rotateSquareBanner(wrapper, result.data.rotate_time);
            }
        });
    },
    ...
    render_ads : function(wrapper, data) {
        ...
        var adswrapper = '<div id="adc_ADV_HOME_4" pan_timer="15" align="center" border="0" cellpadding="0" cellspacing="0">';
