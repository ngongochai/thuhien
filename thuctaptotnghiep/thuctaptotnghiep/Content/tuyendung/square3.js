var Square3 = {
    ...
    exec_request : function () {
        var requestURL = 'vclick/index.php?group=common&zone=7';
        var wrapper = jQuery('#ads_ADV_HOME_3');
        Square3.display_animation(wrapper, true);

        jQuery.ajax({
            url: requestURL,
            success: function(result)
            {
                Square3.display_animation(wrapper, false);
                ...
                Square3.render_ads(wrapper, result.data.result);
                Square3.rotateSquareBanner(wrapper, result.data.rotate_time);
            }
        });
    },
    ...
    render_ads : function(wrapper, data) {
        ...
        var adswrapper = '<div id="adc_ADV_HOME_3" pan_timer="15" align="center" border="0" cellpadding="0" cellspacing="0">';
